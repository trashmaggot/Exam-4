...
public class CatTable {
    ...
    public void printTable(Comparator<Cat> comparator) {
        ...
        cats.forEach(cat -> {
            if (cat.isHasPlayed()) System.out.println("You played with " + cat.getName() + " " + cat.getAge() + " years old");
            if (cat.isHasFeed()) System.out.println("You feed " + cat.getName() + " " + cat.getAge() + " years old");
            if (cat.isHasVet()) System.out.println("You took to Vet " + cat.getName() + " " + cat.getAge() + " years old");
        });
        System.out.println("---+----------+-----------+-----------+----------+----------+----------+");
